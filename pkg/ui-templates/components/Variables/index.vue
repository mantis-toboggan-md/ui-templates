...
// import { componentForType } from '../../util/uitemplate-variables';
...
export default {
  name: 'UITemplateVariables',

  components: {
    Variable, GroupPanel, Accordion
  },
  // error is emitted when an error occurs parsing or generating yaml. validation-passed corresponds to validation defined in the uitemplate spec
  ...
  props: {
    ...
    // array of variable values -- definitions are contained in uitemplate
    value: {
      type:    Array,
      default: () => {
        return [];
